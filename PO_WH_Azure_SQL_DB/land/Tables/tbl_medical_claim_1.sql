CREATE TABLE [land].[tbl_medical_claim_1] (
    ...
    [First_Date_of_Service]         DATE           NOT NULL,
    [Paid_Date]                     DATE           NOT NULL,
    [Debit_Credit_Code]             NVARCHAR (MAX) NULL,
    [Carrier Member ID]             NVARCHAR (MAX) NULL,
    ...
    [Deductible_Amount]             DECIMAL (9, 2) NOT NULL,
    [Coinsurance_Amount]            DECIMAL (9, 2) NOT NULL,
    [Copay_Amount]                  DECIMAL (9, 2) NOT NULL,
